...
export const dict = {
  ...
  "error.chain.networkUnreachable": "無法連線到該 provider —— 請檢查網路或代理設定。",
  "error.chain.authRequired": "驗證失敗 —— 請檢查該 provider 的 API key 或登入狀態。",
  ...
  "session.answers.collapseAll": "全部折疊",
  "session.answers.expandAll": "全部展開",
